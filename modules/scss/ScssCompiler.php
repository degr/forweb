 ...
 * representing the CSS structure by `Scss_Compiler`. The CSS tree is fed into a
 ...
 *
 * The `parse` function of `Scss_Compiler` is the entry point.
 *
 * In summary:
 *
 * The `Scss_Compiler` class creates an instance of the parser, feeds it SCSS code,
